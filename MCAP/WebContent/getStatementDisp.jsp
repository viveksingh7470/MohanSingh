...
<br>
<h2>Get Statement Sussessfull</h2> </font>
        		<h3>
        			<font color="white">
        			<%
        			session=request.getSession();
        			out.println("The recipants accno is : "+session.getAttribute("al1"));
        			out.println("The recipants accno is : "+session.getAttribute("al2"));
