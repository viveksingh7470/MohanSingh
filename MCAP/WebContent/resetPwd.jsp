...
<div class="container" style="background-color:#000;  background:rgba(0,0,0,0.7);margin-top:50px; box-shadow:    
        ...
        <h1>&nbsp;&nbsp;<font color="#FFFFFF";>Reset password</font></h1>
        </div>
    </div>
  </div>
  <br>
...
<form action="ResetPdw">
	<div class="row wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
        ...
        <fieldset class="col-md-12" style="margin-top:10px; "> 
         <legend>Reset Pwd</legend>
         <br>

        	<div class="form-group">
    
    <input type="password" class="form-control" 
   required="required" placeholder="Enter the Old Password"name="oldpwd">
  </div>
  <br>
  <div class="form-group">
    
    <input type="password" class="form-control" 
   required="required" placeholder="Enter the new Password "name="newpwd">
  </div>
  <br>
  <div class="form-group">
    
    <input type="password" class="form-control" 
   required="required" placeholder="Enter the Confirm pwd "name="cnewpwd">
  </div>
  <br>
   &nbsp; &nbsp;&nbsp;  &nbsp; &nbsp;&nbsp;  &nbsp; &nbsp;&nbsp; 
    &nbsp; &nbsp;&nbsp;  &nbsp; &nbsp;&nbsp; 
